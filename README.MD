...
* 0:09 camelCase
* 0:10 views
* 0:14 APIView -> Generic -> ModelViewSet
* 0:22 func get APIView
* 0:25 CreateAPIView mixins
* 0:34 ViewSet
* 0:40 only
* 0:43 ModelViewSet
* 0:47 relax 1:13
...
4. (Задание со *) В модели ToDo добавить фильтрацию по дате создания. Передадим 2 даты, дату начала и окончания (https://django-filter.readthedocs.io/en/latest/index.html).
